...
/**
 * Interface for classes that use a clock or time measurement source of a specific system, such as the default
 * {@link System#currentTimeMillis()}, and video game current tick time since startup.
 */
